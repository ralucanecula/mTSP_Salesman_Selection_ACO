...
public class Utilities {
    ...
    private static String filePath = "../../../Jurnale/jurnal Swarm Intelligence/Experimente/Rulari ACS si MMAS (fara local search)_" + TSP_ACO.instanceName + ".xlsx";
    private static String filePath1 = "../../../Jurnale/jurnal Swarm Intelligence/Experimente/Fronturi Pareto algoritmi (pe parcurs)/ACS MinMax_voiajor random/ParetoFront_" + TSP_ACO.instanceName + " (m=" + MTsp.m + ")_amplitude_2200 iter (ACS MinMax_voiajor random)" + ".xlsx";
    private static String filePath2 = "../../../Jurnale/jurnal Swarm Intelligence/Experimente/fisiere intermediare/Rulari ACS MinMax_voiajor random_" + TSP_ACO.instanceName + " (m=" + MTsp.m + ")_total, subtour costs and amplitude.txt";
...
*/	            //XSSFSheet sheet6 = workbook1.getSheetAt(startIndex + 5);  //for verbose output of longest cost at each 5 iteration
	            ...
	            if (!saveIterCosts) {
	            	...
	            	if (trialNumber == 0) {
			            ...
			            c.setCellValue("Obtained solutions (values) after running vers. I (ACO (ACS) MinMax global, voiajor ales random)");
	            ...
	            if (saveIterCosts) {
	            	...
	            	if (trialNumber == 0) {
			            ...
			            c.setCellValue("Longest cost of subtour at each 5 iteration after running vers. I (ACO (ACS) MinMax global, voiajor ales random)");
			            c.setCellStyle(styleBoldBlue);
