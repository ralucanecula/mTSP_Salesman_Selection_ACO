...
public class Utilities {
    ...
    private static String filePath1 = "../../../Jurnale/jurnal Swarm Intelligence (Springer)/Experimente/Fronturi Pareto algoritmi (pe parcurs)/ACO MinMax_voiajor determ/ParetoFront_" + TSP_ACO.instanceName + " (m=" + MTsp.m + ")_amplitude_2200 iter (ACO MinMax_voiajor det)" + ".xlsx";
    private static String filePath2 = "../../../Jurnale/jurnal Swarm Intelligence (Springer)/Experimente/fisiere intermediare/Rulari ACO MinMax_voiajor determinist_" + TSP_ACO.instanceName + " (m=" + MTsp.m + ")_total, subtour costs and amplitude.txt";
	            ...
	            */
	            ...
	            if (!saveIterCosts) {
	            	...
	            	if (trialNumber == 0) {
			            ...
			            c.setCellValue("Obtained solutions (values) after running vers. II (ACO MinMax global, voiajor ales determinist)");
	            ...
	            if (saveIterCosts) {
	            	...
	            	if (trialNumber == 0) {
			            ...
			            c.setCellValue("Longest cost of subtour at each 5 iteration after running vers. II (ACO MinMax global, voiajor ales determinist)");
			            c.setCellStyle(styleBoldBlue);
