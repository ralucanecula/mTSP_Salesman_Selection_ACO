...
public class Utilities {
    ...
    private static String filePath = "../../../Jurnale/jurnal Swarm Intelligence/Experimente/Rulari ACO MinMax_" + TSP_ACO.instanceName + ".xlsx";
    ...
    private static String filePath1 = "../../../Jurnale/jurnal Swarm Intelligence/Experimente/Fronturi Pareto algoritmi (pe parcurs)/ACS MinMax_vers. noua (cu local search)/ParetoFront_" + TSP_ACO.instanceName + " (m=" + MTsp.m + ")_amplitude_1400 iter (ACS_vers noua_ls)" + ".xlsx";
    private static String filePath2 = "../../../Jurnale/jurnal Swarm Intelligence/Experimente/fisiere intermediare/Rulari ACS MinMax_vers noua_ls_" + TSP_ACO.instanceName + " (m=" + MTsp.m + ")_total, subtour costs and amplitude.txt";
